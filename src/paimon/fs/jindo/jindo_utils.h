...
/// Maps a jindo file-not-found error to Status::NotExist so that callers can distinguish
/// a missing file from other IO errors, consistent with LocalFileSystem.
