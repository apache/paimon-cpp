...
void LazyConcatBatchReader::CloseCurrent() {
    ...
    // Released here rather than held to the end: a batch it handed out retains what it needs of
    // it, so a partition of many files does not keep one reader per file alive.
