...
///
/// The parts of `FileStoreWrite` about manifests and snapshots - compaction, and the commit
/// identifier a streaming write carries - have nothing here to act on and are refused.
