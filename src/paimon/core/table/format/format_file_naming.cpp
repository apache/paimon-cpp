...
Result<std::unique_ptr<FormatFileNaming>> FormatFileNaming::Create(const std::string& extension,
    ...
    return std::unique_ptr<FormatFileNaming>(new FormatFileNaming(uuid, extension, prefix));
}
