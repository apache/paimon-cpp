...
f_row: [(7,"nested",123456789012345.6789), null, null]
...
Java Avro supports timestamp precision only through 6. VARIANT and its nested forms are omitted
because Java cannot derive an Avro schema for them.
